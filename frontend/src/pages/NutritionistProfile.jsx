                  ...
                  <Box component="section" sx={{ p: 2, border: '4px dashed green' }}>
                    <Stack direction={"row"} padding={2}>
                      <Stack direction={"column"}>
                        ...
                        <span style={{ fontSize: "60px", fontWeight: "bold", marginLeft: "5px" }}>22.1</span>
                      </Stack>
              ...
              <td className="pt-[200px] pl-[160px]">
                <div className="text-right">
                  <Stack direction={"row"} spacing={2} className="text-right">
                    <Button
                      variant="contained"
                      className="px-8 py-4 text-[15px] font-medium text-[#008000] bg-transparent border border-[#008000] rounded-full hover:bg-[#006400] hover:text-[#FEFEFA] transition duration-300 ease-in-out"
                    >
                      <Link to="/GuestProfile">CANCEL</Link>
                    </Button>
                    <Button
                      variant="contained"
                      className="px-8 py-4 text-[15px] font-medium text-white bg-[#008000] border border-[#008000] rounded-full hover:bg-[#006400] hover:text-[#FEFEFA] transition duration-300 ease-in-out"
                    >
                      <Link to="/GuestProfile">SAVE CHANGES</Link>
                    </Button>
                  </Stack>
                </div>
              </td>
